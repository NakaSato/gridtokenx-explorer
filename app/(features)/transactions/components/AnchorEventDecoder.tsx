  ...
  return (
    <div className="mb-4">
      ...
      <div className="rounded-md border border-blue-200 bg-blue-50 px-4 py-3 text-blue-800">
        <strong>Energy Trading Events:</strong> Monitor your platform's energy trades, settlements, and user actions
      </div>
          ...
          <div className="p-6">
            ...
            {(event.data.toString().toLowerCase().includes('energy') ||
              ...
              <div className="mt-2 mb-0 rounded-md border border-green-200 bg-green-50 px-4 py-3 text-green-800">
                <small>
                  <strong>Energy Trading Event Detected!</strong> This log likely represents a trade, settlement, or
                  platform action in your P2P energy marketplace.
                </small>
              </div>
            )}
          </div>
