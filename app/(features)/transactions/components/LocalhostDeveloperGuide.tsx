...
Anchor.toml                    # Cluster config`}
          ...
          <div className="mt-4 mb-0 rounded-md border border-yellow-200 bg-yellow-50 px-4 py-3 text-yellow-900">
            ...
            <ul className="small mb-0">
              <li>
                <strong>Test with realistic data:</strong> Use actual energy amounts in your tests (e.g., kWh values)
              </li>
              <li>
                <strong>Monitor gas costs:</strong> Track compute units to optimize for mainnet deployment
              </li>
              <li>
                <strong>Use program logs:</strong> Add <code>msg!</code> macros in your Rust code for debugging
              </li>
              <li>
                <strong>Reset state:</strong> Use <code>solana-test-validator --reset</code> for clean slate
              </li>
              <li>
