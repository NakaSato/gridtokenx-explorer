        ...
        return (
          ...
          >
            ...
            <tr>
              ...
              <td className="font-mono lg:text-right">{`${new Intl.NumberFormat('en-US').format(
                units,
              )} compute units`}</td>
            </tr>
        ...
        return (
          ...
          >
            ...
            <tr>
              ...
              <td className="font-mono lg:text-right">{new Intl.NumberFormat('en-US').format(bytes)}</td>
            </tr>
          </InstructionCardComponent>
        );
      }
        ...
        return (
          ...
          >
            ...
            <tr>
              ...
              <td className="font-mono lg:text-right">{`${microLamportsToLamportsString(
                microLamports,
        ...
        return (
          ...
          >
            ...
            <tr>
              ...
              <td className="font-mono lg:text-right">{`${accountDataSizeLimit} bytes`}</td>
            </tr>
          </InstructionCardComponent>
        );
      }
