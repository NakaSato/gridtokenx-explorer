...
vi.mock('@/app/(core)/providers/accounts', () => ({
...
vi.mock('@/app/(core)/providers/accounts/utils/isMetaplexNFT', () => ({
  default: vi.fn(() => false),
}));
...
vi.mock('@/app/(shared)/utils/token-info', () => ({
...
describe('AccountHeader', () => {
  describe('ProgramHeader', () => {
    ...
    it('should render with default values when no security.txt is available', () => {
      ...
      render(
        <AccountHeader address={mockAddress} account={account} tokenInfo={undefined} isTokenInfoLoading={false} />,
      );
