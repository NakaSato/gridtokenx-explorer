...
export function UpgradeableLoaderAccountSection({
  ...
  switch (parsedData.type) {
    case 'program': {
      return <UpgradeableProgramSection account={account} programAccount={parsedData.info} programData={programData} />;
    }
    case 'programData': {
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg">{programData === undefined && 'Closed '}Program Account</CardTitle>
...
function VerifiedLabel() {
  return (
    <InfoTooltip text="Verified builds allow users can ensure that hash of on-chain program matches the hash of the program of given codebase (registry hosted by osec.io).">
      <Link rel="noopener noreferrer" target="_blank" href="https://github.com/Ellipsis-Labs/solana-verifiable-build">
