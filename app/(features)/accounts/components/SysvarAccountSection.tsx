  ...
  return (
    <div className="bg-card rounded-lg border shadow-sm">
      ...
      <TableCardBody>
        ...
        <tr>
          <td>Timestamp</td>
          <td className="font-mono lg:text-right">{displayTimestamp(sysvarAccount.info.unixTimestamp * 1000)}</td>
        </tr>
    ...
    <div className="bg-card rounded-lg border shadow-sm">
      ...
      <TableCardBody>
        ...
        <tr>
          ...
          <td className="font-mono lg:text-right">{validatorPointValueFormatted} lamports</td>
        </tr>
      </TableCardBody>
    </div>
  );
