...
import { parseFeatureAccount, useFeatureAccount } from '@/app/(shared)/utils/parseFeatureAccount';
          ...
          {featureInfo.simds.map((simd, index) => (
            <div key={index}>
              {simd && featureInfo.simd_link[index] ? (
                <a href={featureInfo.simd_link[index]} target="_blank" rel="noopener noreferrer" className="">
    ...
    <div className="bg-card rounded-lg border shadow-sm">
      ...
      <TableCardBody layout="expanded">
        ...
        <tr>
          ...
          <td className="lg:text-right">
            <ClusterActivationEpochAtCluster cluster={cluster} clusterInfo={clusterInfo} activatedAt={activatedAt} />
          </td>
        </tr>
