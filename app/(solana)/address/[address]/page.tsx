import { TransactionHistoryCard } from '@/app/(features)/accounts/components/history/TransactionHistoryCard';
...
export default async function TransactionHistoryPage({ params, searchParams }: Props) {
