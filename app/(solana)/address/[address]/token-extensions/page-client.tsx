...
import { MintAccountInfo, TokenAccountInfo } from '@/app/(solana)/validators/accounts/token';
...
function TokenExtensionsEntriesRenderer({
  ...
  if (parsedData && parsedData.parsed.type === 'mint') {
    ...
    return (
      <TokenExtensionsCard decimals={Number(mintInfo.decimals)} address={address} extensions={mintInfo.extensions} />
    );
