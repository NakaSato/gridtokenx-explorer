  ...
  return (
    <div className="bg-card rounded-lg border shadow-sm">
      <div className="p-6 text-center">
        ...
        <div className="mb-4">
          <p>
            This program did not provide Security.txt information yet. If you are the maintainer of this program you can
            use the following command to add your information.
          </p>
