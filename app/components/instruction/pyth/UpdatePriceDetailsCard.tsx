...
export default function UpdatePriceDetailsCard({
    ...
    return (
        ...
        >
            ...
            <tr>
                <td>Status</td>
                <td className="lg:text-right">{TradingStatus[info.status]}</td>
            </tr>

            <tr>
                <td>Price</td>
                <td className="lg:text-right">{info.price}</td>
            </tr>

            <tr>
                <td>Conf</td>
                <td className="lg:text-right">{info.conf}</td>
            </tr>

            <tr>
                <td>Publish Slot</td>
                <td className="lg:text-right">{info.publishSlot}</td>
            </tr>
        </InstructionCard>
    );
}
