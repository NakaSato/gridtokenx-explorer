...
export function MangoDetailsCard(props: {
  ...
  try {
    ...
    switch (title) {
      ...
      case 'SettleFunds':
        return <GenericSpotMngoDetailsCard accountKeyLocation={2} spotMarketkeyLocation={5} title={title} {...props} />;
      case 'RedeemMngo':
        return (
          <GenericPerpMngoDetailsCard mangoAccountKeyLocation={3} perpMarketKeyLocation={4} title={title} {...props} />
        );
