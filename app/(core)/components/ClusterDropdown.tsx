  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <Button
        ...
        className={`flex min-w-[140px] items-center justify-between gap-2 sm:min-w-[160px] md:min-w-[180px] lg:min-w-[200px] ${getStatusButtonClass()}`}
      >
      ...
      {/* Dropdown Menu */}
      {isOpen && (
        <div className="absolute top-full right-0 z-50 mt-2 w-72 rounded-md border border-gray-200 bg-white shadow-lg sm:w-80 md:w-96 dark:border-gray-700 dark:bg-gray-800">
          <div className="p-3 sm:p-4">
            <h3 className="mb-3 text-sm font-semibold text-gray-900 dark:text-white">Choose a Cluster</h3>
                  ...
                  return (
                    <div key={index} className="space-y-2">
                      <Button
                        ...
                        className={`h-10 w-full justify-start sm:h-9 ${active ? 'bg-blue-500 text-white' : ''}`}
                      >
                      ...
                      {showCustomInput && (
                        <div className="mt-2">
                          <input
                            ...
                            className="w-full rounded-md border border-gray-300 bg-white px-3 py-2.5 text-sm transition-all duration-200 focus:border-transparent focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                            autoFocus
                          />
                        </div>
                      )}
