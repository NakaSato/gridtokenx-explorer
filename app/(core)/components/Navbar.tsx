      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            {/* Mobile menu button */}
            <button
              className="focus:ring-primary inline-flex h-10 w-10 items-center justify-center rounded-lg p-2 text-gray-600 transition-all duration-200 hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-offset-2 focus:outline-none active:scale-95 dark:text-gray-300 dark:hover:bg-gray-700 dark:hover:text-white"
              type="button"
