...
import { GovernanceExplorer } from '@/app/(features)/anchor-localnet/components/GovernanceExplorer';

export default function GovernancePageClient() {
  const { cluster, url } = useCluster();
  // Like Trading, we'll try to fetch using the localnet hook
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-6">
        <h1 className="mb-6 text-2xl font-bold md:text-3xl">Governance Program</h1>
