...
const INCIDENTS: Record<IncidentId, IncidentDescription> = {
  'ftx-hack-november-2022': (
    <>
      <div className="rounded-md border border-red-200 bg-red-50 px-4 py-3 text-red-900" role="alert">
        Warning! This program&apos;s upgrade key may have been compromised by the FTX hack. Please migrate to the
        community fork:{' '}
        <Link
  ...
  'known-scam': (
    <>
      <div className="rounded-md border border-red-200 bg-red-50 px-4 py-3 text-red-900" role="alert">
        Warning! This account has been flagged by the community as a scam account. Please be cautious sending SOL to
        this account.
      </div>
    </>
  ),
